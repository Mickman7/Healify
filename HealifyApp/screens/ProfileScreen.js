  ...
  return (
    <View style={{justifyContent: 'space-evenly'}}>
       <Header
        ...
        <TouchableOpacity style={{flexDirection: 'row', alignItems: 'center', marginHorizontal: 10, padding: 15, justifyContent: 'space-between', borderBottomWidth: 1}} onPress={() => navigation.navigate('PatientDetails')}>
